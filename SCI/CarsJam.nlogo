...
cars-own [origin destination speed perception accelF brakeF]



to setup
  ca
  create-nodes 2 [set shape "circle" set color 6 set size 0.5]
  ask node 0 [setxy min-pxcor 0]
  ask node 1 [setxy max-pxcor 0]
  ask nodes with [who > 0] [create-link-from node 0]
  addcar
  reset-ticks
end
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot [speed] of one-of cars"
